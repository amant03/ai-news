      ...
      <div className="mx-auto max-w-lg text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col sm:flex-row gap-2.5">
          ...
          <button
            ...
            className="ring-focus bg-[var(--aa-plum)] px-6 py-3 text-sm font-semibold text-[#fff] tracking-tight transition-all hover:opacity-90 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
            {status === 'loading' ? (
