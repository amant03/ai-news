        ...
        {tags.map(([word, count]) => {
          ...
          return (
            <button
              ...
              className="ring-focus text-xs px-2.5 py-1 rounded-full border border-[var(--color-line)] text-[var(--mut)] hover:text-[var(--accent)] hover:border-[var(--accent)]/40 hover:bg-[var(--accent)]/5 transition-all"
