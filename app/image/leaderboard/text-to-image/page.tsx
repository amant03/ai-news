...
function valueOf(m: T2IModel, key: SortKey): number | string | undefined {
  switch (key) {
      ...
      <main className="max-w-[1400px] mx-auto px-5 pt-8 pb-16">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="font-display text-4xl md:text-5xl font-medium tracking-tight text-[var(--fore)]">Text to Image Leaderboard</h1>
                ...
                {sorted.map((m, idx) => (
                  <tr key={m.rank} className="border-b border-[var(--color-line)] hover:bg-neutral-50 transition-colors">
                    ...
                    <td className="py-2.5 px-4">
                      ...
                      {m.openWeights && (
                        <span className="ml-2 text-[9px] uppercase tracking-wider px-1.5 py-px rounded-full border border-[var(--ok-ink)]/30 text-[var(--ok-ink)]">
                          Open
                        </span>
                      )}
                    </td>
